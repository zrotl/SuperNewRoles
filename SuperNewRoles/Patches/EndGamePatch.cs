...
public class EndGameManagerSetUpPatch
{
    ...
    public static void Postfix(EndGameManager __instance)
    {
        ...
        List<CachedPlayerData> list = EndGameResult.CachedWinners.ToList();
...
public static class OnGameEndPatch
{
    ...
    private static void ProcessAdditionalWin(ref HashSet<NetworkedPlayerInfo> winners, GameOverReason gameOverReason, ref WinCondition winCondition)
    {
        ...
        {
            if (RoleClass.Revolutionist.IsAddWin && (!RoleClass.Revolutionist.IsAddWinAlive || player.IsAlive()) && !EndGameResult.CachedWinners.Contains(new(player.Data)))
            {
                winners.Add(player.Data);
            }
        }
