...
class MapCustom
{
    ...
    {
        MapCustomOption = Create(102800, true, CustomOptionType.Generic, CustomOptionHolder.GetCsWithTranslation(new Color(132f / 187f, 162f / 255f, 212f / 255f, 1f), "MapCustom"), false, null, true);
