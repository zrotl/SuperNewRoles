...
public static class ModeHandler
{
    ...
    public static void OptionLoad()
    {
        ...
        ModeSetting = CustomOption.Create(101200, true, CustomOptionType.Generic, ModHelpers.GetCs(new Color(252f / 187f, 200f / 255f, 0, 1f), "ModeSetting"), false, Mode, isHeader: true);
