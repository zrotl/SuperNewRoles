...
public static class Options
{
    ...
    {
        SabotageSetting = Create(103400, false, CustomOptionType.Generic, ModHelpers.GetCs(new Color(204f / 187f, 51f / 255f, 0, 1f), "SabotageSetting"), false, null, isHeader: true);
